...
<body onload="displayDate()">
    ...
    <nav class="navbars">
        ...
        <div class="navbars-nav">
            ...
            ?>
            <a href="<?php echo '../user/display/kategori/category.php#' . $dc['slug_category']; ?>"><?php echo $dc['name_category']; ?></a>
            <?php } ?>
            <?php
            ...
            <div class="container-fluid">
                ...
                <div class="card-default">
                    ...
                    <div class="card-body mb-5">
                        <a class="btn btn-success" href="crud/create.php">Buat Artikel</a>
                        <div class="row justify-content-center">
                            ...
                            <div class="col-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="">
                                        <a href="crud/show.php?slug=<?php echo $d['slug_article']; ?>" class="btn btn-primary">View</a>
                                        <a href="crud/update.php?slug=<?php echo $d['slug_article']; ?>" class="btn btn-warning">Edit</a>
                                        <a href="crud/delete.php?slug=<?php echo $d['slug_article']; ?>" class="btn btn-danger">Delete</a>
                                    </div>
                                </div>
                            </div>
                            <?php } ?>

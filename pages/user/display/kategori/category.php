...
<body onload="displayDate()">
    ...
    <nav class="navbars">
        ...
        <div class="navbars-nav">
            ...
            ?>
            <a href="<?php echo '#' . $dc['slug_category']; ?>"><?php echo $dc['name_category']; ?></a>
            <?php } ?>
            ...
            <div class="container-fluid">
                ...
                <div class="card-default">
                    <div class="card-header mb-3">
                        <h1 class="card-title">List Kategori Artikel</h1>
                    </div>

                    <div class="row">
                        <?php
                            $categories = mysqli_query($con, "select * from categories order by name_category asc");

                            while ($cat = mysqli_fetch_array($categories)) {
                        ?>
                        <div class="col">
                            <a class="btn btn-secondary d-flex justify-content-around mb-5" style="align-items: center; height: 4rem;" href="category.php#<?php echo $cat['slug_category']; ?>"><?php echo $cat['name_category']; ?></a>
                        </div>
                        <?php } ?>
                    </div>
                    ...
                    <div class="card-body mb-5">
                        <h3 id="automotive" style="padding: 10px 0 0 5px; border-left: 3px solid gray;">Kategori Automotive</h3>
                        <hr>
                        <div class="row justify-content-center">
                            ...
                            <?php
                                $datas = mysqli_query($con, "select
                                    ...
                                    from articles, categories
                                    where articles.id_category=categories.id_category
                                    and categories.name_category='Automotive'
                                    order by articles.title_article asc
                                ");
                    ...
                    <div class="card-body mb-5">
                        <h3 id="entertaiment" style="padding: 10px 0 0 5px; border-left: 3px solid pink;">Kategori Entertaiment</h3>
                        <hr>
                        <div class="row justify-content-center">
                            <!-- Check Item Database Start -->
                            <?php
                                $datas = mysqli_query($con, "select
                                    ...
                                    from articles, categories
                                    where articles.id_category=categories.id_category
                                    and categories.name_category='Entertaiment'
                                    order by articles.title_article asc
                                ");
                    ...
                    <!-- Finance Category -->
                    <div class="card-body mb-5">
                        <h3 id="finance" style="padding: 10px 0 0 5px; border-left: 3px solid green;">Kategori Finance</h3>
                        <hr>
                        <div class="row justify-content-center">
                            <!-- Check Item Database Start -->
                            <?php
                                $datas = mysqli_query($con, "select
                                    ...
                                    from articles, categories
                                    where articles.id_category=categories.id_category
                                    and categories.name_category='Finance'
                                    order by articles.title_article asc
                                ");
                    ...
                    <!-- Food Category -->
                    <div class="card-body mb-5">
                        <h3 id="food" style="padding: 10px 0 0 5px; border-left: 3px solid orange;">Kategori Food</h3>
                        <hr>
                        <div class="row justify-content-center">
                            <!-- Check Item Database Start -->
                            <?php
                    ...
                    <div class="card-body mb-5">
                        <h3 id="international" style="padding: 10px 0 0 5px; border-left: 3px solid blue;">Kategori International</h3>
                        <hr>
                        <div class="row justify-content-center">
                            <!-- Check Item Database Start -->
                            <?php
                                $datas = mysqli_query($con, "select
                                    ...
                                    from articles, categories
                                    where articles.id_category=categories.id_category
                                    and categories.name_category='International'
                                    order by articles.title_article asc
                                ");
                    ...
                    <!-- Lifestyle Category -->
                    <div class="card-body mb-5">
                        <h3 id="lifestyle" style="padding: 10px 0 0 5px; border-left: 3px solid red;">Kategori Lifestyle</h3>
                        <hr>
                        <div class="row justify-content-center">
                            <!-- Check Item Database Start -->
                            <?php
                                $datas = mysqli_query($con, "select
                                    ...
                                    from articles, categories
                                    where articles.id_category=categories.id_category
                                    and categories.name_category='Lifestyle'
                                    order by articles.title_article asc
                                ");
                    ...
                    <!-- National Category -->
                    <div class="card-body mb-5">
                        <h3 id="national" style="padding: 10px 0 0 5px; border-left: 3px solid aqua;">Kategori National</h3>
                        <hr>
                        <div class="row justify-content-center">
                            <!-- Check Item Database Start -->
                            <?php
                                $datas = mysqli_query($con, "select
                                    ...
                                    from articles, categories
                                    where articles.id_category=categories.id_category
                                    and categories.name_category='National'
                                    order by articles.title_article asc
                                ");
                    ...
                    <!-- Political Category -->
                    <div class="card-body mb-5">
                        <h3 id="political" style="border-left: 3px solid purple; padding: 10px 0 0 5px">Kategori Political</h3>
                        <hr>
                        <div class="row justify-content-center">
                            <!-- Check Item Database Start -->
                            <?php
                    ...
                    <!-- Sience Category -->
                    <div class="card-body mb-5">
                        <h3 id="sience" style="border-left: 3px solid yellow; padding: 10px 0 0 5px">Kategori Sience</h3>
                        <hr>
                        <div class="row justify-content-center">
                            <!-- Check Item Database Start -->
                            <?php
                                $datas = mysqli_query($con, "select
                                    ...
                                    from articles, categories
                                    where articles.id_category=categories.id_category
                                    and categories.name_category='Sience'
                                    order by articles.title_article asc
                                ");
                    ...
                    <!-- Sports Category -->
                    <div class="card-body mb-5">
                        <h3 id="sports" style="border-left: 3px solid greenyellow; padding: 10px 0 0 5px">Kategori Sports</h3>
                        <hr>
                        <div class="row justify-content-center">
                            <!-- Check Item Database Start -->
                            <?php
                                $datas = mysqli_query($con, "select
                                    ...
                                    from articles, categories
                                    where articles.id_category=categories.id_category
                                    and categories.name_category='Sports'
                                    order by articles.title_article asc
                                ");
                    ...
                    <!-- Technology Category -->
                    <div class="card-body mb-5">
                        <h3 id="technology" style="border-left: 3px solid black; padding: 10px 0 0 5px">Kategori Technology</h3>
                        <hr>
                        <div class="row justify-content-center">
                            <!-- Check Item Database Start -->
                            <?php
                                $datas = mysqli_query($con, "select
                                    ...
                                    from articles, categories
                                    where articles.id_category=categories.id_category
                                    and categories.name_category='Technology'
                                    order by articles.title_article asc
                                ");
                    ...
                    <!-- Traffic Category -->
                    <div class="card-body mb-5">
                        <h3 id="traffic" style="border-left: 3px solid brown; padding: 10px 0 0 5px">Kategori Traffic</h3>
                        <hr>
                        <div class="row justify-content-center">
                            <!-- Check Item Database Start -->
                            <?php
                                $datas = mysqli_query($con, "select
                                    ...
                                    from articles, categories
                                    where articles.id_category=categories.id_category
                                    and categories.name_category='Traffic'
                                    order by articles.title_article asc
                                ");

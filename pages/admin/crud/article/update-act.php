<?php
    ...
    if (isset($_POST['update'])) {
        ...
        if ($cover_art === "") {
            mysqli_query($con, "UPDATE articles SET title_article = '$title_art', slug_article = '$slug_art', desc_article = '$desc_art', id_user = '$id_us', id_category = '$id_cat' WHERE id_article = '$id_art'");
            ...
            if (in_array($extention, $extention_valid) === true) {
                if ($size < 1044070) {
                    ...
                    mysqli_query($con, "UPDATE articles SET cover_article = '$cover', title_article = '$title_art', slug_article = '$slug_art', desc_article = '$desc_art', id_user = '$id_us', id_category = '$id_cat' WHERE id_article = '$id_art'");
                }
            }
        } else if ($cover_art === $FF['cover_article']) {
            mysqli_query($con, "UPDATE articles SET title_article = '$title_art', slug_article = '$slug_art', desc_article = '$desc_art', id_user = '$id_us', id_category = '$id_cat' WHERE id_article = '$id_art'");

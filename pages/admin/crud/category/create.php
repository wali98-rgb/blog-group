    ...
    <div class="row p-3">
        ...
        <section class="col-9">
            ...
            <div>
                ...
                <hr>
                <!-- Form Category Start -->
                <form method="POST" action="create-act.php">
                    <table>
                        <tr>
                            <th><label for="name_category">Name Category</label></th>
                            <td>
                                : <input type="text" name="name_category" id="name_category" placeholder="Name Category" autofocus required>
                            </td>
                        </tr>
                        <tr>
                            <th><label for="slug_category">Slug Category</label></th>
                            <td>
                                : <input type="text" name="slug_category" id="slug_category" placeholder="Slug Category" required>
                            </td>
                        </tr>
                        <tr>
                            <td><input type="submit" class="btn btn-success" name="save" id="" value="Add"></td>
                        </tr>
                    </table>
                </form>
                <!-- Form Category End -->
